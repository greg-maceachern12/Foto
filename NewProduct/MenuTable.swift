...
//  NewProduct
//
//  Created by Greg  MacEachern on 2017-07-07.
...
class MenuTable: UIViewController, UITableViewDataSource, UITableViewDelegate {
                    ...
                    self.dataRef.child("users").child(self.loggedUser!.uid).observe(.value, with: { (snapshot) in
                        if snapshot.exists() == true
                        {
                            ...
                            if self.skills == ""{
                                ...
                                self.dataRef.child("artistProfiles").child(self.loggedUser!.uid).child("Name").setValue(self.name)
                                
                                self.dataRef.child("artistProfiles").child(self.loggedUser!.uid).child("token").setValue(self.loggedUser!.uid)
                                
                                
                                self.dataRef.child("artistProfiles").child(self.loggedUser!.uid).child("Skills").setValue(self.skills)
                                
                                self.dataRef.child("artistProfiles").child(self.loggedUser!.uid).child("Email").setValue(self.email)
                                ...
                                self.present(myVCArtist, animated: true)
