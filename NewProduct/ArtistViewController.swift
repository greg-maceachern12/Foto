...
class ArtistViewController: UIViewController, UITextViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIBarPositioningDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        myImageView.image = #imageLiteral(resourceName: "Default") //initializing the picker rows thumbnail image
        
        switch row {
        case 0:
            //using the "verified" image as a placeholder. If the image is the temp image"verified", it couldn't find the image in firebase directory
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        //Keeps track of which row was clicked to have the image uploaded.
    ...
    func editMessage() -> String {
        ...
        //the message when a user tries to edit one of the pricing characteristics at a certain index
        if self.count == 0{
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt: IndexPath) -> [UITableViewRowAction]? {  //swipe to edit feature
